...
export const IMG = {
  heroPortrait1: u("photo-1531123414780-f74242c2b052", 800, 1000), // young leader
  heroPortrait2: u("photo-1694286066858-462538cd9886", 800, 1000), // confident woman
  heroPortrait3: u("photo-1694286066815-4e17284d61ab", 800, 1000), // smiling woman
  heroPortrait4: u("photo-1522529599102-193c0d76b5b6", 800, 1000), // confident man
  mentorship: u("photo-1637856794303-d864ce316444", 1400, 1000),    // group meeting
  ...
  growth: u("photo-1739298061740-5ed03045b280", 1400, 1000),        // classroom
